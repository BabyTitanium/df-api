...
public class TikuXiyizhiyeChapter {
    private Integer id;
    ...
    public TikuXiyizhiyeChapter(Integer id, Integer chapterId, Integer chapterParentId, String title, Integer sort) {
        this.id = id;
