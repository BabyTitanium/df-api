...
public class TikuZhiyezhongyaoshiQuestion {
    private Integer id;
    ...
    public TikuZhiyezhongyaoshiQuestion(Integer id, Integer questionId, Integer chapterId, Integer chapterParentId, String title, String titleImg, Integer sNum, String number, String year, String unit, String numberNumber, String numberType, String explainImg, Integer type, String answer, Integer mediaId, String mediaUrl, String mediaImg) {
        this.id = id;
    ...
    public TikuZhiyezhongyaoshiQuestion() {
        super();
    }
